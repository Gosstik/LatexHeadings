...
\usepackage{xspace}     % automatic spacing after textual commands
...
% \usepackage{XCharter} % this supports Cyrillic for russian
...
\usepackage[
    backend=biber,
    style=numeric,
    % sorting=nyt % alphabetical sorting order
    sorting=none % sort by appearing in the text
    ]{biblatex}
